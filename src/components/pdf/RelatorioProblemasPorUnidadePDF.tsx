...
const RelatorioProblemasUnidadePDF = ({ dataInicio, dataFim, dados }: PdfProps) => {
    ...
    <Document>
      <Page size="A4" style={styles.page} wrap>
        ...
        <View style={styles.headerSection}>
          <Text style={styles.title}>Relatório de Problemas por Unidade</Text>
          {(dataInicio && dataFim) && (
        ...
        <View style={styles.table}>
          <View style={styles.tableHeaderRow} fixed>
            ...
            <View style={styles.tableColHeaderQty}>
              <Text style={styles.tableCellHeaderQty}>Quant. Problemas</Text>
            </View>
          </View>
...
export { RelatorioProblemasUnidadePDF };
